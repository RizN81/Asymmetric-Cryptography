...
public class AsymmetricCryptography {
	...
	public String encryptText(String msg, PrivateKey key) throws NoSuchAlgorithmException, NoSuchPaddingException, UnsupportedEncodingException, IllegalBlockSizeException,
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("Getting Public and Private Keys");
		...
		System.out.println("Encrypting Data with Private Kye");
		String encrypted_msg = ac.encryptText(msg, privateKey);

		System.out.println("Encrypting encrypted data with public key");
		String decrypted_msg = ac.decryptText(encrypted_msg, publicKey);
		System.out.println("Original Message: " + msg + "\nEncrypted Message: " + encrypted_msg + "\nDecrypted Message: " + decrypted_msg);

		//Now Same approach With file
		if (new File("KeyPair/text.txt").exists())
		{
			System.out.println("Encrypting text file with private key");
			ac.encryptFile(ac.getFileInBytes(new File("KeyPair/text.txt")), new File("KeyPair/text_encrypted.txt"), privateKey);
			System.out.println("Now decrypting text file with public key");
